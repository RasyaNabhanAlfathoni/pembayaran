...
// Query untuk menghitung jumlah notifikasi pembayaran yang belum diproses
$query = "SELECT COUNT(*) AS total FROM pembayaran WHERE ket = 'MENUNGGU'"; // Sesuaikan dengan kondisi status yang Anda miliki
$result = mysqli_query($conn, $query);
$data = mysqli_fetch_assoc($result);
$jumlah_notifikasi = $data['total'];
?>
...
<head>
    ...
    <style>
        .badge-notifikasi {
        position: absolute; /* Posisi badge */
        top: 0; /* Atur posisi atas */
        right: 0; /* Atur posisi kanan */
        transform: translate(-380%, 0%); /* Agar badge terletak di sudut kanan atas */
    }
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Operator <sup></sup></div>
            </a>
           ...
           <!-- Nav Item - Pages Collapse Menu for Master Data -->
<li class="nav-item">
...
<!-- Nav Item - Pages Collapse Menu for Laporan -->
<li class="nav-item">
    ...
    <div id="collapseLaporan" class="collapse" aria-labelledby="headingLaporan" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="notifikasi_pembayaran.php" style="position: relative;">
                Lihat Notifikasi
                <?php if ($jumlah_notifikasi > 0): ?>
                    <span class="badge badge-danger badge-notifikasi"><?= $jumlah_notifikasi ?></span>
                <?php endif; ?>
            </a>
        </div>
    </div>
